  ...
  <div class="min-h-screen bg-black text-white">
    <main class="px-6 py-8 max-w-6xl mx-auto">
      ...
      <div class="flex justify-between items-center mb-4">
        ...
        <select
          v-model="$i18n.locale"
          class="border border-gray-500 bg-black px-3 py-2 rounded-lg text-sm"
        >
      ...
      <form
        ...
        class="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8 items-end"
      >
        <input
        ...
        <select
          ...
          class="border border-gray-500 bg-black px-3 py-2 rounded-lg text-sm col-span-1"
        >
        ...
        <div class="flex gap-2 col-span-1">
          <select
            ...
            class="border border-gray-500 bg-black px-3 py-2 rounded-lg text-sm w-full"
          >
        ...
        <div class="flex gap-3 lg:col-span-3">
          ...
          <button
            type="button"
            @click="resetFilters"
            class="border border-gray-500 px-5 py-2 rounded-lg text-sm"
          >
            {{ t('clear') }}
          </button>
        </div>
        ...
        <li v-for="job in jobs" :key="job.id" class="job-item border-b border-gray-700 pb-4">
          ...
          <div class="actions mt-3 flex gap-3">
            <router-link :to="`/job/edit/${job.id}`">
              <button class="border border-gray-500 px-4 py-2 rounded-lg text-sm">
                {{ t('edit') }}
              </button>
            </router-link>
            <button
              @click="confirmDelete(job.id)"
              class="border border-gray-500 px-4 py-2 rounded-lg text-sm"
            >
              {{ t('delete') }}
            </button>
